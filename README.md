...
- Ideally videos should have dimensions 256 x 70 or some multiple of that, but other aspect ratios will work (see horizontal/vertical offset controls to adjust the crop)
